...
const columns = [
  ...
  { field: 'fabricComposition', headerName: 'Fabric Composition', width: 150 },
  { field: 'trims', headerName: 'Trims', width: 100 },
  { field: 'sustainability', headerName: 'Sustainability', width: 150 },
  { field: 'washCare', headerName: 'Wash Care', width: 100 },
  { field: 'style', headerName: 'Style', width: 100 },
  { field: 'searchableText', headerName: 'Searchable Text', width: 150 },  {
    field: 'actions',
    headerName: 'Actions',
    width: 100,
    sortable: false,
